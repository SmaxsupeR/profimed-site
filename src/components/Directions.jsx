      ...
      <div className="border-t border-slate-200 dark:border-slate-800 reveal-stagger">
        {DIRECTIONS.map(({ id }, i) => {
          ...
          return (
            <div
              key={id}
              className="group border-b border-slate-200 py-6 transition-colors dark:border-slate-800"
            >
              <div className="grid gap-x-5 gap-y-3 sm:grid-cols-[40px_1fr_auto] sm:items-baseline">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 transition-colors group-hover:text-primary-700 dark:text-slate-50 dark:group-hover:text-primary-300">{t.dir[`d${n}t`]}</h3>
