...
export function MobileCallBar() {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed inset-x-0 bottom-0 z-45 flex gap-2.5 px-4 py-3 bg-white border-t border-slate-200 dark:bg-slate-900 dark:border-slate-800">
